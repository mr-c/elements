...
func _CombinatorialLibraryDesign_Scarfree_3PartRequirements() {
	// e.g. are MoClo types valid?
}

// Conditions to run on startup
func _CombinatorialLibraryDesign_Scarfree_3PartSetup(_ctx context.Context, _input *CombinatorialLibraryDesign_Scarfree_3PartInput) {
}

// The core process for this protocol, with the steps to be performed
// for every input
func _CombinatorialLibraryDesign_Scarfree_3PartSteps(_ctx context.Context, _input *CombinatorialLibraryDesign_Scarfree_3PartInput, _output *CombinatorialLibraryDesign_Scarfree_3PartOutput) {
	...
	for j := range _input.Vectors {
		for k := range _input.Part1s {
			for l := range _input.Part2s {
				...
				key := _input.ProjectName + "_" + _input.Vectors[j].Name() + "_" + _input.Part1s[k].Name() + "_" + _input.Part2s[l].Name()
...
func _CombinatorialLibraryDesign_Scarfree_3PartAnalysis(_ctx context.Context, _input *CombinatorialLibraryDesign_Scarfree_3PartInput, _output *CombinatorialLibraryDesign_Scarfree_3PartOutput) {
}

// A block of tests to perform to validate that the sample was processed correctly
// Optionally, destructive tests can be performed to validate results on a
// dipstick basis
func _CombinatorialLibraryDesign_Scarfree_3PartValidation(_ctx context.Context, _input *CombinatorialLibraryDesign_Scarfree_3PartInput, _output *CombinatorialLibraryDesign_Scarfree_3PartOutput) {
}
func _CombinatorialLibraryDesign_Scarfree_3PartRun(_ctx context.Context, input *CombinatorialLibraryDesign_Scarfree_3PartInput) *CombinatorialLibraryDesign_Scarfree_3PartOutput {
	output := &CombinatorialLibraryDesign_Scarfree_3PartOutput{}
	_CombinatorialLibraryDesign_Scarfree_3PartSetup(_ctx, input)
	_CombinatorialLibraryDesign_Scarfree_3PartSteps(_ctx, input, output)
	_CombinatorialLibraryDesign_Scarfree_3PartAnalysis(_ctx, input, output)
	_CombinatorialLibraryDesign_Scarfree_3PartValidation(_ctx, input, output)
	return output
}

func CombinatorialLibraryDesign_Scarfree_3PartRunSteps(_ctx context.Context, input *CombinatorialLibraryDesign_Scarfree_3PartInput) *CombinatorialLibraryDesign_Scarfree_3PartSOutput {
	soutput := &CombinatorialLibraryDesign_Scarfree_3PartSOutput{}
	output := _CombinatorialLibraryDesign_Scarfree_3PartRun(_ctx, input)
...
func CombinatorialLibraryDesign_Scarfree_3PartNew() interface{} {
	return &CombinatorialLibraryDesign_Scarfree_3PartElement{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &CombinatorialLibraryDesign_Scarfree_3PartInput{}
			...
			In:  &CombinatorialLibraryDesign_Scarfree_3PartInput{},
			Out: &CombinatorialLibraryDesign_Scarfree_3PartOutput{},
		},
	}
}
...
type CombinatorialLibraryDesign_Scarfree_3PartElement struct {
	inject.CheckedRunner
}

type CombinatorialLibraryDesign_Scarfree_3PartInput struct {
...
type CombinatorialLibraryDesign_Scarfree_3PartOutput struct {
...
type CombinatorialLibraryDesign_Scarfree_3PartSOutput struct {
	Data struct {
		AssembledSequences    wtype.File
		Assemblies            map[string][]wtype.DNASequence
		EndreportMap          map[string]string
...
func init() {
	if err := addComponent(component.Component{Name: "CombinatorialLibraryDesign_Scarfree_3Part",
		Constructor: CombinatorialLibraryDesign_Scarfree_3PartNew,
		Desc: component.ComponentDesc{
			...
			Path: "src/github.com/antha-lang/elements/an/Data/DNA/TypeIISAssembly_design/CombinatorialDesign/scarfree/CombinatorialLibraryDesign_Scarfree_3Part.an",

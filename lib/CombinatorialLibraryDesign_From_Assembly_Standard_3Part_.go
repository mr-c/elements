...
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartRequirements() {
	// e.g. are MoClo types valid?
}

// Conditions to run on startup
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartSetup(_ctx context.Context, _input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput) {
}

// The core process for this protocol, with the steps to be performed
// for every input
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartSteps(_ctx context.Context, _input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput, _output *CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput) {
	...
	for key, value := range refactoredparts {
		...
		if len(duplicateremoved) == 0 {
			execute.Errorf(_ctx, "No Sequences to export for %s!", key)
		}
...
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartAnalysis(_ctx context.Context, _input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput, _output *CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput) {
}

// A block of tests to perform to validate that the sample was processed correctly
// Optionally, destructive tests can be performed to validate results on a
// dipstick basis
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartValidation(_ctx context.Context, _input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput, _output *CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput) {
}
func _CombinatorialLibraryDesign_From_Assembly_Standard_3PartRun(_ctx context.Context, input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput) *CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput {
	output := &CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput{}
	_CombinatorialLibraryDesign_From_Assembly_Standard_3PartSetup(_ctx, input)
	_CombinatorialLibraryDesign_From_Assembly_Standard_3PartSteps(_ctx, input, output)
	_CombinatorialLibraryDesign_From_Assembly_Standard_3PartAnalysis(_ctx, input, output)
	_CombinatorialLibraryDesign_From_Assembly_Standard_3PartValidation(_ctx, input, output)
	return output
}

func CombinatorialLibraryDesign_From_Assembly_Standard_3PartRunSteps(_ctx context.Context, input *CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput) *CombinatorialLibraryDesign_From_Assembly_Standard_3PartSOutput {
	soutput := &CombinatorialLibraryDesign_From_Assembly_Standard_3PartSOutput{}
	output := _CombinatorialLibraryDesign_From_Assembly_Standard_3PartRun(_ctx, input)
...
func CombinatorialLibraryDesign_From_Assembly_Standard_3PartNew() interface{} {
	return &CombinatorialLibraryDesign_From_Assembly_Standard_3PartElement{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput{}
			...
			In:  &CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput{},
			Out: &CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput{},
		},
	}
}
...
type CombinatorialLibraryDesign_From_Assembly_Standard_3PartElement struct {
	inject.CheckedRunner
}

type CombinatorialLibraryDesign_From_Assembly_Standard_3PartInput struct {
...
type CombinatorialLibraryDesign_From_Assembly_Standard_3PartOutput struct {
...
type CombinatorialLibraryDesign_From_Assembly_Standard_3PartSOutput struct {
	Data struct {
		AssembledSequences    wtype.File
		Assemblies            map[string][]wtype.DNASequence
		EndreportMap          map[string]string
...
func init() {
	if err := addComponent(component.Component{Name: "CombinatorialLibraryDesign_From_Assembly_Standard_3Part",
		Constructor: CombinatorialLibraryDesign_From_Assembly_Standard_3PartNew,
		Desc: component.ComponentDesc{
			Desc: "This protocol is intended to design a combinatorial library of all combinations of a list of Vectors, Promoters,\nRBSs, CDSs and Terminators according to an assembly standard ensuring compatibility with level 1 design.\nLevel 1 adaptor sites (containing the correct restriction site are expected to be included in the promoter and terminator parts.\nThese level 1 sites can be designed such that a series of level 1 parts may be joined together in a second assembly reaction.\nA list of sequencing primers to order will also be returned.\n",
			Path: "src/github.com/antha-lang/elements/an/Data/DNA/TypeIISAssembly_design/CombinatorialDesign/MoClo/Hierarchical/CombinatorialLibraryDesign_From_Assembly_Standard_3Part.an",

...
func _SampleExercise4Requirements() {

}

// Conditions to run on startup
func _SampleExercise4Setup(_ctx context.Context, _input *SampleExercise4Input) {

}

// The core process for this protocol, with the steps to be performed
// for every input
func _SampleExercise4Steps(_ctx context.Context, _input *SampleExercise4Input, _output *SampleExercise4Output) {
	...
	dilutedsampleAmix := execute.Mix(_ctx, dilutedsampleA...)
	dilutedsampleBmix := execute.Mix(_ctx, dilutedsampleB...)

	_output.DilutedSampleA = dilutedsampleAmix
	_output.DilutedSampleB = dilutedsampleBmix

}

// Run after controls and a steps block are completed to
// post process any data and provide downstream results
func _SampleExercise4Analysis(_ctx context.Context, _input *SampleExercise4Input, _output *SampleExercise4Output) {
}

// A block of tests to perform to validate that the sample was processed
//correctly. Optionally, destructive tests can be performed to validate
//results on a dipstick basis
func _SampleExercise4Validation(_ctx context.Context, _input *SampleExercise4Input, _output *SampleExercise4Output) {

}
func _SampleExercise4Run(_ctx context.Context, input *SampleExercise4Input) *SampleExercise4Output {
	output := &SampleExercise4Output{}
	_SampleExercise4Setup(_ctx, input)
	_SampleExercise4Steps(_ctx, input, output)
	_SampleExercise4Analysis(_ctx, input, output)
	_SampleExercise4Validation(_ctx, input, output)
	return output
}

func SampleExercise4RunSteps(_ctx context.Context, input *SampleExercise4Input) *SampleExercise4SOutput {
	soutput := &SampleExercise4SOutput{}
	output := _SampleExercise4Run(_ctx, input)
...
func SampleExercise4New() interface{} {
	return &SampleExercise4Element{
		inject.CheckedRunner{
			RunFunc: func(_ctx context.Context, value inject.Value) (inject.Value, error) {
				input := &SampleExercise4Input{}
			...
			In:  &SampleExercise4Input{},
			Out: &SampleExercise4Output{},
		},
	}
}
...
type SampleExercise4Element struct {
	inject.CheckedRunner
}

type SampleExercise4Input struct {
...
type SampleExercise4Output struct {
...
type SampleExercise4SOutput struct {
	Data struct {
		StatusA string
		StatusB string
	}
...
func init() {
	if err := addComponent(component.Component{Name: "SampleExercise4",
		Constructor: SampleExercise4New,
		Desc: component.ComponentDesc{
			Desc: "Example protocol demonstrating the use of the Sample function\n",
			Path: "src/github.com/antha-lang/elements/an/AnthaAcademy/AnthaLangAcademy/Lesson2_Sample/JAJALesson2/SampleExercise4/SampleExercise4.an",
